        ...
        <div style={{ padding: 32 }}>
          ...
          {error && (
            <div style={{ marginTop: 16, padding: 12, background: "#ffebee",
              borderRadius: 8, color: "#c62828", fontSize: 13 }}>⚠️ {error}</div>
          )}
        </div>
      </div>
    </div>
            ...
            <div style={{ display: "flex", marginBottom: 24, borderRadius: 8,
              ...
              <button onClick={() => setType("SELL")}
                style={{ flex: 1, padding: 14, border: "none", cursor: "pointer",
                  ...
                  color: type === "SELL" ? "white" : "#666" }}>
                📉 SELL
              </button>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <div>
                <label style={{ display: "block", marginBottom: 6, fontWeight: "bold", color: "#555" }}>Price (₹)</label>
